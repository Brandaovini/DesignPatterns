public class PlayerEstadoStart implements PlayerEstado{

    private PlayerEstadoStart(){};
    private static PlayerEstadoStart instance = new PlayerEstadoStart();
    public static PlayerEstadoStart getInstance(){
        return instance;
    }
