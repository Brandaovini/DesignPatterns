public class PlayerEstadoBanido implements PlayerEstado{

    private PlayerEstadoBanido(){}
    private static PlayerEstadoBanido instance = new PlayerEstadoBanido();
    public static PlayerEstadoBanido getInstance(){
        return instance;
    }
